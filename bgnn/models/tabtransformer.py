...
class tabtransformer(BaseModel):
    def __init__(self, task='classification', 
                 channels=32, out_channels=1, num_heads=4, num_layers=5, lr=0.001,
                 gamma=0.95, attn_dropout=0.3, ffn_dropout=0.3, encoder_pad_size=2):
        ...
        self.encoder_pad_size = encoder_pad_size
    ...
    def fit(self, X, y, train_mask, val_mask, test_mask, num_epochs,
        ...
        self.model = TabTransformer(channels=self.channels,
                                    out_channels=self.out_channels,
                                    num_layers=self.num_layers, 
                                    num_heads=self.num_heads,
                                    encoder_pad_size=self.encoder_pad_size,
